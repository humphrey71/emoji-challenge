        ...
        <div className="min-h-screen">
            ...
            <header className="fixed top-0 w-full bg-white shadow-sm z-50">
                <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                    <a
                        href="/"
                        className="flex items-center gap-2 text-[#FF6B6B] hover:text-[#ff8f8f] transition-colors font-bold text-xl"
                    >
                    ...
                    <nav>
                        <Button asChild variant="default">
                            <a href="#try-kitchen">Explore Kitchen</a>
                        </Button>
                    </nav>
                </div>
            </header>
            ...
            <footer className="bg-[#2C3E50] text-white py-8 text-center">
                <div className="container mx-auto px-4">
                    <p>&copy; 2024 EmojiChallenge.org - Your Gateway to Creative Emoji Expression</p>
                </div>
            </footer>
        </div>
    )
